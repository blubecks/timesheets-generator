                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{route('projects.store')}}"  enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="manager_first_name" class="block mt-1 w-full" type="text" name="manager_first_name" value="{{ old('manager_first_name') }}"/>
                        </div>
                        <div class="mt-4">
                            <x-label for="manager_last_name" :value="__('Manager Last Name')" />
                            <x-input id="manager_last_name" class="block mt-1 w-full" type="text" name="manager_last_name" value="{{ old('manager_last_name') }}"/>
                        </div>
                        <div class="mt-4">
